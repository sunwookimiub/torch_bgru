...
class RNNBase(Module):
    ...
    def __init__(self, mode, input_size, hidden_size,
        ...
        elif 'GRU' in mode: #mode == 'GRU' or mode == 'GRU_AutogradRNN':
    ...
    def flatten_parameters(self):
        ...
        with torch.cuda.device_of(any_param):
            import torch_bgru.backends.cudnn.rnn as rnn
    ...
    def forward(self, input, hx=None):
        ...
        # print ("RNNBase: calling _backend.RNN with mode:{}".format(self.mode))
...
class GRU_AutogradRNN(RNNBase):

    def __init__(self, *args, **kwargs):
        super(GRU_AutogradRNN, self).__init__('GRU_AutogradRNN', *args, **kwargs)

class Binary_GRU(RNNBase):

    def __init__(self, *args, **kwargs):
        super(Binary_GRU, self).__init__('Binary_GRU', *args, **kwargs)
...
class GRUCell(RNNCellBase):
    ...
    # NOTE: Only called when torch.nn.GRUCell is called
...
class TanhGRUCell(RNNCellBase):
    ...
    def forward(self, input, hx=None):
        ...
        if hx is None:
            hx = input.new_zeros(input.size(0), self.hidden_size, requires_grad=False)
        self.check_forward_hidden(input, hx)
        return self._backend.TanhGRUCell(
            input, hx,
            self.weight_ih, self.weight_hh,
            self.bias_ih, self.bias_hh,
        )
